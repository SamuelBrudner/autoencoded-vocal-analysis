...
def tooltip_plot_DC(
    ...
    tooltip_plot(
        embedding, images, output_dir=output_dir, num_imgs=num_imgs, title=title, n=n, grid=grid
    )


def tooltip_plot(
    embedding, images, output_dir="temp", num_imgs=10000, title="", n=30000, grid=False
):
    """
