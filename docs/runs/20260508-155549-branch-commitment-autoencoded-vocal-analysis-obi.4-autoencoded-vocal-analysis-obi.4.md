...
- Events analyzed: 114690.
- Adult-like branches: K=8 from 22000 late-age events.
- Confidence age Spearman rho: 0.959 (bootstrap CI [0.919, 0.975]).
- Entropy age Spearman rho: -0.918 (bootstrap CI [-0.955, -0.842]).
- Nearest branch distance age Spearman rho: -0.949 (bootstrap CI [-0.975, -0.887]).
- Distance margin age Spearman rho: 0.944 (bootstrap CI [0.870, 0.979]).
- Probability margin age Spearman rho: 0.949 (bootstrap CI [0.888, 0.979]).
- Sensitivity signs replicate: yes.
- Coverage/skips: Coverage/skips vary across dph and could plausibly bias branch metrics.

## Figures

![Branch confidence and entropy](artifacts/autoencoded-vocal-analysis-obi.4/20260508-155549-branch-commitment-autoencoded-vocal-analysis-obi.4/figures/branch_confidence_entropy.png)

![Nearest branch distance](artifacts/autoencoded-vocal-analysis-obi.4/20260508-155549-branch-commitment-autoencoded-vocal-analysis-obi.4/figures/branch_nearest_distance.png)

![Branch margins](artifacts/autoencoded-vocal-analysis-obi.4/20260508-155549-branch-commitment-autoencoded-vocal-analysis-obi.4/figures/branch_margins.png)

![Branch composition](artifacts/autoencoded-vocal-analysis-obi.4/20260508-155549-branch-commitment-autoencoded-vocal-analysis-obi.4/figures/branch_composition.png)

![Within-branch dispersion](artifacts/autoencoded-vocal-analysis-obi.4/20260508-155549-branch-commitment-autoencoded-vocal-analysis-obi.4/figures/within_branch_dispersion.png)

![Bias controls](artifacts/autoencoded-vocal-analysis-obi.4/20260508-155549-branch-commitment-autoencoded-vocal-analysis-obi.4/figures/branch_bias_controls.png)

## Interpretation

Confidence increases with age. Entropy decreases with age. Events move closer to adult branch centers. Branch margins increase.
...
```json
{
  ...
  "clips_seen": 95402,
  "coverage_counts_available": true,
  "coverage_source": "docs/runs/artifacts/autoencoded-vocal-analysis-obi.2/20260507-182654-pk249-hyperbolic-development-autoencoded-vocal-analysis-obi.2/metrics.json",
  "dph_max": 90.0,
  "dph_min": 33.0,
  "entries_selected": 58,
...
- `branch_commitment`: `artifacts/autoencoded-vocal-analysis-obi.4/20260508-155549-branch-commitment-autoencoded-vocal-analysis-obi.4/branch_commitment.parquet`
- `branch_clusters`: `artifacts/autoencoded-vocal-analysis-obi.4/20260508-155549-branch-commitment-autoencoded-vocal-analysis-obi.4/branch_clusters.json`
- `metrics`: `artifacts/autoencoded-vocal-analysis-obi.4/20260508-155549-branch-commitment-autoencoded-vocal-analysis-obi.4/metrics.json`
