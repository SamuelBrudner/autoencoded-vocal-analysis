...
loaders = get_fixed_window_data_loaders(partition, params, num_workers=num_workers, batch_size=128)
...
temp_dc = DataContainer(
    projection_dirs=proj_dirs[:1],
    audio_dirs=audio_dirs[:1],
    spec_dirs=spec_dirs[:1],
    plots_dir=root,
    model_filename=model_filename,
)
