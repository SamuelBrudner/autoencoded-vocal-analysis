#!/usr/bin/env python3
"""Launcher for manifest-driven fixed-window birdsong training.

This is a thin wrapper around `ava.models.lightning_vae.train_vae` that adds:
- manifest/config/save-dir CLI
- ROI duration preflight
- optional trainer override knobs for scaled runs (multi-GPU, AMP, etc.)
"""
